...
import com.project.lorvent.way2freshers.activities.SplashActivity;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!NetworkStatus.isConnected(WelcomeActivity.this))
        {
            Intent i = new Intent(WelcomeActivity.this, NetworkErrorActivity.class);
            startActivity(i);
            finish();
        }
