...
public class LatestFragment extends Fragment {
    ...
    private class GetAllLatestJob extends AsyncTask<String, Void, String> {
        String response;
        @Override
    ...
    public void onSaveInstanceState(Bundle outState) {
            ...
            outState.putParcelableArrayList("latestArrayList",latestArrayList);
            Log.i("state", String.valueOf(recyclerView.getLayoutManager().onSaveInstanceState()));
    ...
    public void onResume() {
        ...
        super.onResume();
        MyApplication.getInstance().trackScreenView("LatestFragment");
